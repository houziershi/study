...
\begin{document}
	...
	\part{语法基础}
		\include{tex/01.language/module}

		\include{tex/01.language/core.data.struct}

		\include{tex/01.language/execute.sequence}

		\include{tex/01.language/function}

		\include{tex/01.language/oop}

		\include{tex/01.language/exception}

		\include{tex/01.language/use.document}

		\include{tex/01.language/base.function}
	\part{常用功能}

		\include{tex/02.cookbook/01.text}

		\include{tex/02.cookbook/02.file}
