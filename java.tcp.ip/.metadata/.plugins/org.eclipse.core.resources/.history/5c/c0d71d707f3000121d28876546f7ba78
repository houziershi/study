...
public class BruteForceCoding {
	...
	public static void main(String[] args) {
		...
		System.out.print(transDataToHexString(byteVal, BYTE_SIZE));
		System.out.print(" ");
		System.out.print(transDataToHexString(shortVal, SHORT_SIZE));
		System.out.print(" ");
		System.out.print(transDataToHexString(intVal, INT_SIZE));
		System.out.print(" ");
		System.out.println(transDataToHexString(longVal, LONG_SIZE));
	...
	public static String transByteStreamToHexString(byte[] byteStream) {
		...
		for (byte b : byteStream) {
			// 用十六进制字符串显示一个字节的内容
			rtn.append(transDataToHexString((long) b, BYTE_SIZE)).append(" ");
		}
		return rtn.toString();
	}
